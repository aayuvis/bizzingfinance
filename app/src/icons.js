...
export const ICONS = {
  ...
  roti: I('treasure',
    ...
    '<circle cx="12" cy="12" r="8.4"/><path d="M12 6.8a5.2 5.2 0 0 1 5.2 5.2"/>',
    '<circle cx="9" cy="10" r=".9"/><circle cx="13.4" cy="14.8" r=".9"/><circle cx="15.2" cy="9.6" r=".7"/><circle cx="8.6" cy="14.2" r=".7"/><circle cx="11.6" cy="12" r=".7"/>'),
  medicine: I('spend',
    '<path d="M8.2 3.6h7.6v4.2H8.2z"/><path d="M6.8 7.8h10.4V19a1.6 1.6 0 0 1-1.6 1.6H8.4A1.6 1.6 0 0 1 6.8 19z"/>',
    '<path d="M8.2 3.6h7.6v4.2H8.2z"/><path d="M6.8 7.8h10.4V19a1.6 1.6 0 0 1-1.6 1.6H8.4A1.6 1.6 0 0 1 6.8 19z"/><path d="M12 11.2v5M9.5 13.7h5"/>'),
  cake: I('give',
    '<path d="M4.6 12.6h14.8V20H4.6z"/>',
    '<path d="M4.6 12.6h14.8V20H4.6z"/><path d="M4.6 15.4c1.2 1.1 2.5 1.1 3.7 0s2.5-1.1 3.7 0 2.5 1.1 3.7 0 2.5-1.1 3.7 0"/><path d="M12 9.4v3.2"/><path d="M12 5.6c-.9 1-.9 2 0 2.8.9-.8.9-1.8 0-2.8z"/>',
    '<circle cx="12" cy="9" r=".9"/>'),
  chain: I('treasure',
    '<path d="M12 4.2a7.8 7.8 0 0 0-7.8 8.4C4.6 17 8 20 12 20s7.4-3 7.8-7.4A7.8 7.8 0 0 0 12 4.2z" fill-opacity="0"/>',
    '<path d="M4.8 6c1.6 4.4 4 6.6 7.2 6.6S17.6 10.4 19.2 6"/><path d="M12 12.6v1.8"/>',
